...
namespace Gamelogic.Grids
{
	...
	*/
	...
	{
		#region Constants
		public static readonly DiamondPoint NorthEast = new DiamondPoint(0, 1);
		public static readonly DiamondPoint NorthWest = new DiamondPoint(-1, 0);
		public static readonly DiamondPoint SouthWest = new DiamondPoint(0, -1);
		public static readonly DiamondPoint SouthEast = new DiamondPoint(1, 0);
