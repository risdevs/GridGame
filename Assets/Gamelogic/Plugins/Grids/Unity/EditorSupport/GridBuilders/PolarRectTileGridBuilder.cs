...
namespace Gamelogic.Grids
{
	...
	*/
	...
	public class PolarRectTileGridBuilder : PolarTileGridBuilder<RectPoint>
	{
		...
		public new RectGrid<MeshTileCell> Grid
		{
			get { return (RectGrid<MeshTileCell>) base.Grid; }
		}
		...
		protected override void InitGrid()
		{
			...
			switch (shape)
			{
				case Shape.Rectangle:
					base.Grid = RectGrid<MeshTileCell>.HorizontallyWrappedParallelogram(width, height);
					break;
